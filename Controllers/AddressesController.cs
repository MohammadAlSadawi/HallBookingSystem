...
namespace FirstProjectHallBooking.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,City,Street")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,City,Street")] Address address)
        {
            if (id != address.Id)
            {
                return NotFound();
