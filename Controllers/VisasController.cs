...
namespace FirstProjectHallBooking.Controllers
{
    public class VisasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CardNumber,Balnce")] Visa visa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,CardNumber,Balnce")] Visa visa)
        {
            if (id != visa.Id)
            {
                return NotFound();
