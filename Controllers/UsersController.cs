...
namespace FirstProjectHallBooking.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Email,Phone,Address,ImagePath,ImageFile")] User user)
        {
            ViewBag.adminname = HttpContext.Session.GetString("Adminname");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,FirstName,LastName,Email,Phone,Address,ImagePath,ImageFile")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        user.ImagePath=PersonalImagepath;
                    }
