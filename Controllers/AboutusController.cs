...
namespace FirstProjectHallBooking.Controllers
{
    public class AboutusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descriptoin")] Aboutu aboutu)
        {
            ViewBag.adminname = HttpContext.Session.GetString("Adminname");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Descriptoin")] Aboutu aboutu)
        {
            ViewBag.adminname = HttpContext.Session.GetString("Adminname");
            if (id != aboutu.Id)
            {
