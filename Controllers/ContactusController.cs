...
namespace FirstProjectHallBooking.Controllers
{
    public class ContactusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Subject,Message,Email")] Contactu contactu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Name,Subject,Message,Email")] Contactu contactu)
        {
            if (id != contactu.Id)
            {
                return NotFound();
